...
function Bar({ pct, color, max = 100 }: { pct: number; color: string; max?: number }) {
  ...
  return (
    <div style={{
      flex: 1, height: 6, background: "var(--bc-panel)", borderRadius: 3, overflow: "hidden",
    }}>
...
function ExpertCard({ expert }: { expert: ExpertPick }) {
  ...
  return (
    <div style={{
      ...
      borderLeft: expert.winner_pick ? "3px solid var(--bc-yellow)" : "3px solid var(--bc-line)",
      ...
      >
        ...
        <div style={{ flex: 1, minWidth: 0 }}>
          <div style={{ display: "flex", alignItems: "baseline", gap: 10, flexWrap: "wrap", marginBottom: 6 }}>
            <span style={{ fontWeight: 700, color: "var(--bc-text)", fontSize: "0.9em" }}>
              {expert.expert_name}
            </span>
            {expert.expert_title && (
      ...
      {expanded && (
        <div style={{ padding: "0 16px 14px", borderTop: "1px solid var(--bc-line)" }}>
