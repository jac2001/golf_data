...
| consecutive_top10s | Current streak of consecutive top-10 finishes |
| consecutive_cuts | Current streak of consecutive cuts made |
| hot_hand_flag | Boolean - player is on a hot streak (3+ top10s, 2+ top5s, or win) |
| hot_hand_score | Momentum score 0-10 (wins=3pts, top5=2pts, top10=1pt + streak bonus) |
| momentum_trend | Momentum category: HOT (5+), WARM (3-5), NEUTRAL (1-3), COLD (<1) |
