...
| driving_dist | No description available |
| driving_acc | No description available |
| gir_pct | No description available |
| scrambling | No description available |
...
| season_driving_dist | No description available |
| season_driving_acc | No description available |
| season_gir_pct | No description available |
| season_scrambling | No description available |
...
| approach_skill_sg | No description available |
| approach_skill_proximity | No description available |
| approach_skill_shot_total | No description available |
| approach_skill_sg_vs_field | No description available |
| dg_skill_total | No description available |
| dg_skill_ott | No description available |
| dg_skill_app | No description available |
| dg_skill_arg | No description available |
| dg_skill_putt | No description available |
| dg_skill_dist | No description available |
| dg_skill_acc | No description available |
| dg_skill_total_vs_field | No description available |
| dg_skill_app_vs_field | No description available |
| dg_skill_ott_vs_field | No description available |
| dg_skill_putt_vs_field | No description available |
| baseline_pred | No description available |
| final_pred | No description available |
| std_deviation | No description available |
| sample_size | No description available |
| course_history_adjustment | No description available |
| total_course_history_adjustment | No description available |
| driving_accuracy_adjustment | No description available |
| driving_distance_adjustment | No description available |
| timing_adjustment | No description available |
| course_fit_delta | No description available |
| dg_final_pred_vs_field | No description available |
| dg_win | No description available |
| dg_top10 | No description available |
...
| field_size | No description available |
| no_cut | No description available |
